                        ...
                        <div className='footer_row'>
                            ...
                            <div className='footer_col quik_links'>
                                ...
                                <ul>
                                    ...
                                    <li><Link to="#0" >Buy</Link></li>
                                    <li><Link to="#0" >Rent</Link></li>
                                    <li><Link to="#0" >List Your Property</Link></li>
                            ...
                            <div className='footer_col popular_tags'>
                                <h4>Popular Tags</h4>
                                <ul>
                                    <li><Link to="#0" >Beautiful</Link></li>
                                    <li><Link to="#0" >Public</Link></li>
                                    <li><Link to="#0" >Travel</Link></li>
                                    <li><Link to="#0" >Entertainment</Link></li>
