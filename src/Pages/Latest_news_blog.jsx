...
const Latest_news_blog = () => {
    ...
    return (
        <>
            <div className='main_wrapper Latest_news_blog_wrapper'>
                            ...
                            <div className='blog_main_description'>
                                ...
                                <div className='Related_tags'>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#0">Expo 2020 Dubai</a></li>
                                ...
                                <div className='social_media_icons'>
                                    <div className='like_blog'>
                                        ...
                                        <a href="#0"><img src={share_icon} alt="share_icon" /></a>
                                    </div>
